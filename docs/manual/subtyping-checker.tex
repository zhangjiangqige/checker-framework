...
The resulting \<.class> files should be on your classpath.
...
\begin{alltt}
  javac -classpath \textit{myqualpath} -processor org.checkerframework.common.subtyping.SubtypingChecker \
